...
<div class="row container-fluid">
    ...
    <div class="col"></div>
    <div class="col"></div>
    <button type="button" class="btn btn-secondary sticky" data-toggle="modal" data-target="#registerModal">
        <div class="col center"></div>
        Register
    </button>
    <button type="button" class="btn btn-secondary sticky" data-toggle="modal" data-target="#loginModal">
        <div class="col center"></div>
        Log In
    </button>
</div>
...
<main class="font size: 12vw">
    ...
    <aside>
        ...
        <div class="row">
            ...
            <div class="col text-center container-sm"><img
                    src="http://2.bp.blogspot.com/--mqQKXiTD0E/UIURXCYUxUI/AAAAAAAAHuQ/8jMmIdkdLX8/s1600/cats_desktop_1920x1200_hd-wallpaper-817100.jpeg"
            ...
            <div class="col text-center container-sm"><img
                    src="https://image.winudf.com/v2/image/Y29tLmFuZHJvbW8uZGV2NjYwNjE0LmFwcDczMTE1M19zY3JlZW5fN18xNTE3MDM4NDQ2XzAzNQ/screen-7.jpg?fakeurl=1&type=.jpg"
                    alt="Cat 3" height="150" width="150" class="rounded-circle cover">
                <br><b>Cat 3</b></br>
                Date: <br>
                Status: <br>
            ...
            <div class="col text-center container-sm">
                <img src="http://wallpapers9.org/wp-content/uploads/2017/05/Cute-Cat-2.jpg" alt="Cat 5" height="150"
                            ...
                            <div class="modal-body">
                                <form action="#">
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" placeholder="Enter First and Last Name"
                                            id="name">
                                    </div>
                                    <div class="form-group">
