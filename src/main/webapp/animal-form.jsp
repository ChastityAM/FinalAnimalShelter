...
<div class="container">
	...
	<div class="card-body">
		...
		<c:if test="${animal != null}">
			<input type="hidden" name="id" value="<c:out value='${animal.idAnimal}' />" />
		</c:if>
		...
		<fieldset class="form-group">
			...
			<label>Type</label>
			<input type="text" value="<c:out value='${ animal.animalType }'/>" 
		...
		<fieldset class="form-group">
			...
			<label>Status</label>
			<input type="text" value="<c:out value='${ animal.animalStatus }'/>" 
		...
		<fieldset class="form-group">
			...
			<label>Date</label>
			<input type="date" value="<c:out value='${ animal.animalDate }'/>" 
		...
		<fieldset class="form-group">
			...
			<label>Image</label>
			<input type="url" value="<c:out value='${ animal.animalImage }'/>" 
